...
//  ImageEditSample
//
//  Created by ちゅーたつ on 2017/12/14.
...
class ACVParcer {
    ...
    init(with ACVFile: String) {
        
        let path = Bundle.main.path(forResource: ACVFile, ofType: "")!
    ...
    func parseACVFileData(fileData: NSData) -> ([Double],[Double],[Double],[Double]) {
